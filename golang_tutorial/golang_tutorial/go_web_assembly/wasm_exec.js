...
<html lang="en">
  ...
  <meta name="request-id" content="3A5B:43DA4:20CBA4:302287:5BEE04DB" data-pjax-transient>
  ...
  <meta name="octolytics-host" content="collector.githubapp.com" /><meta name="octolytics-app-id" content="github" /><meta name="octolytics-event-url" content="https://collector.githubapp.com/github-external/browser_event" /><meta name="octolytics-dimension-request_id" content="3A5B:43DA4:20CBA4:302287:5BEE04DB" /><meta name="octolytics-dimension-region_edge" content="ams" /><meta name="octolytics-dimension-region_render" content="iad" />
...
<meta class="js-ga-set" name="dimension1" content="Logged Out">
    ...
    <meta name="js-proxy-site-detection-payload" content="">

    <meta name="enabled-features" content="DASHBOARD_V2_LAYOUT_OPT_IN,EXPLORE_DISCOVER_REPOSITORIES,UNIVERSE_BANNER,MARKETPLACE_PLAN_RESTRICTION_EDITOR">

  <meta name="html-safe-nonce" content="4e6c259f68337c987873322a95e239d4ef02a2d1">
...
>
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="js-site-search-form" data-scope-type="Repository" data-scope-id="23096959" data-scoped-search-url="/golang/go/search" data-unscoped-search-url="/search" action="/golang/go/search" accept-charset="UTF-8" method="get"><input name="utf8" type="hidden" value="&#x2713;" />
      <label class="form-control header-search-wrapper header-search-wrapper-jump-to position-relative d-flex flex-justify-between flex-items-center js-chromeless-input-container">
        <input type="text"
          ...
          aria-label="Search"
          data-jump-to-suggestions-path="/_graphql/GetSuggestedNavigationDestinations#csrf-token=bAA8x9LfKzR/Snj8YoMr7N6GaT6VVgTAFE+4YPuVWAiHsuUau7dF1UC/00ySMmKILHRxoSwCIQZCFlYxuEfdRA=="
          spellcheck="false"
          autocomplete="off"
          >
  ...
  <a class="social-count" href="/golang/go/watchers"
     aria-label="3253 users are watching this repository">
    3,253
  </a>
  ...
  <li>
    ...
    <a class="social-count js-social-count" href="/golang/go/stargazers"
      aria-label="49292 users starred this repository">
      49,292
    </a>
  ...
  <li>
    ...
    <a href="/golang/go/network/members" class="social-count"
       aria-label="6805 users forked this repository">
      6,805
    </a>
  </li>
</ul>
  ...
  <span class="author" itemprop="author"><a class="url fn" rel="author" data-hovercard-type="organization" data-hovercard-url="/orgs/golang/hovercard" href="/golang">golang</a></span><!--
...
<div class="container new-discussion-timeline experiment-repo-nav  ">
  <div class="repository-content ">
    ...
    <a class="d-none js-permalink-shortcut" data-hotkey="y" href="/golang/go/blob/14608976dbaff72b7ff6b41b66623c959eaded28/misc/wasm/wasm_exec.js">Permalink</a>

    <!-- blob contrib key: blob_contributors:v21:5452fed431be59003e9b5658ff1cd756 -->

        <div class="signup-prompt-bg rounded-1">
      <div class="signup-prompt p-4 text-center mb-4 rounded-1">
        <div class="position-relative">
          <!-- '"` --><!-- </textarea></xmp> --></option></form><form action="/site/dismiss_signup_prompt" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="yTQMh3cuUVhmCbRmKXwSvz6PsQDnYVXKcsPRyn1kC2Y26J2RNsu6oSmjQPJ7Ake5S0z17qJFh8R6WPsZf1Jg7w==" />
...
<div class="select-menu branch-select-menu js-menu-container js-select-menu float-left">
  ...
  <div class="commit-tease">
      <span class="float-right">
        <a class="commit-tease-sha" href="/golang/go/commit/6dd70fc5e391eb7a47be5eb6353107f38b73f161" data-pjax>
          6dd70fc
        </a>
        <relative-time datetime="2018-11-10T11:57:17Z">Nov 10, 2018</relative-time>
      </span>
      <div>
        ...
        <a class="user-mention" rel="contributor" data-hovercard-type="user" data-hovercard-url="/hovercards?user_id=16184" data-octo-click="hovercard-link-click" data-octo-dimensions="link_type:self" href="/neelance">neelance</a>
          <a data-pjax="true" title="all: add support for synchronous callbacks to js/wasm
...
TryBot-Result: Gobot Gobot &lt;gobot@golang.org&gt;" class="message" href="/golang/go/commit/6dd70fc5e391eb7a47be5eb6353107f38b73f161">all: add support for synchronous callbacks to js/wasm</a>
      </div>
...
<details class="details-reset details-overlay details-overlay-dark lh-default text-gray-dark float-left mr-2" id="blob_contributors_box">
  ...
  <div itemprop="text" class="blob-wrapper data type-javascript ">
      ...
      <tr>
        ...
        <td id="LC82" class="blob-code blob-code-inner js-file-line">			<span class="pl-c1">this</span>.<span class="pl-smi">_exitPromise</span> <span class="pl-k">=</span> <span class="pl-k">new</span> <span class="pl-en">Promise</span>((<span class="pl-smi">resolve</span>) <span class="pl-k">=&gt;</span> {</td>
      </tr>
      <tr>
        <td id="L83" class="blob-num js-line-number" data-line-number="83"></td>
        <td id="LC83" class="blob-code blob-code-inner js-file-line">				<span class="pl-c1">this</span>.<span class="pl-smi">_resolveExitPromise</span> <span class="pl-k">=</span> resolve;</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC85" class="blob-code blob-code-inner js-file-line">			<span class="pl-c1">this</span>.<span class="pl-smi">_pendingCallback</span> <span class="pl-k">=</span> <span class="pl-c1">null</span>;</td>
      </tr>
      <tr>
        <td id="L86" class="blob-num js-line-number" data-line-number="86"></td>
        <td id="LC86" class="blob-code blob-code-inner js-file-line">			<span class="pl-c1">this</span>.<span class="pl-smi">_callbackTimeouts</span> <span class="pl-k">=</span> <span class="pl-k">new</span> <span class="pl-en">Map</span>();</td>
      </tr>
      <tr>
        <td id="L87" class="blob-num js-line-number" data-line-number="87"></td>
        <td id="LC87" class="blob-code blob-code-inner js-file-line">			<span class="pl-c1">this</span>.<span class="pl-smi">_nextCallbackTimeoutID</span> <span class="pl-k">=</span> <span class="pl-c1">1</span>;</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC89" class="blob-code blob-code-inner js-file-line">			<span class="pl-k">const</span> <span class="pl-c1">mem</span> <span class="pl-k">=</span> () <span class="pl-k">=&gt;</span> {</td>
      </tr>
      <tr>
        <td id="L90" class="blob-num js-line-number" data-line-number="90"></td>
        <td id="LC90" class="blob-code blob-code-inner js-file-line">				<span class="pl-c"><span class="pl-c">//</span> The buffer may change when requesting more memory.</span></td>
      </tr>
      <tr>
        <td id="L91" class="blob-num js-line-number" data-line-number="91"></td>
        <td id="LC91" class="blob-code blob-code-inner js-file-line">				<span class="pl-k">return</span> <span class="pl-k">new</span> <span class="pl-en">DataView</span>(<span class="pl-c1">this</span>.<span class="pl-smi">_inst</span>.<span class="pl-smi">exports</span>.<span class="pl-smi">mem</span>.<span class="pl-smi">buffer</span>);</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC94" class="blob-code blob-code-inner js-file-line">			<span class="pl-k">const</span> <span class="pl-c1">setInt64</span> <span class="pl-k">=</span> (<span class="pl-smi">addr</span>, <span class="pl-smi">v</span>) <span class="pl-k">=&gt;</span> {</td>
      </tr>
      <tr>
        <td id="L95" class="blob-num js-line-number" data-line-number="95"></td>
        <td id="LC95" class="blob-code blob-code-inner js-file-line">				<span class="pl-en">mem</span>().<span class="pl-en">setUint32</span>(addr <span class="pl-k">+</span> <span class="pl-c1">0</span>, v, <span class="pl-c1">true</span>);</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC99" class="blob-code blob-code-inner js-file-line">			<span class="pl-k">const</span> <span class="pl-c1">getInt64</span> <span class="pl-k">=</span> (<span class="pl-smi">addr</span>) <span class="pl-k">=&gt;</span> {</td>
      </tr>
      <tr>
        <td id="L100" class="blob-num js-line-number" data-line-number="100"></td>
        <td id="LC100" class="blob-code blob-code-inner js-file-line">				<span class="pl-k">const</span> <span class="pl-c1">low</span> <span class="pl-k">=</span> <span class="pl-en">mem</span>().<span class="pl-en">getUint32</span>(addr <span class="pl-k">+</span> <span class="pl-c1">0</span>, <span class="pl-c1">true</span>);</td>
      </tr>
      <tr>
        <td id="L101" class="blob-num js-line-number" data-line-number="101"></td>
        <td id="LC101" class="blob-code blob-code-inner js-file-line">				<span class="pl-k">const</span> <span class="pl-c1">high</span> <span class="pl-k">=</span> <span class="pl-en">mem</span>().<span class="pl-en">getInt32</span>(addr <span class="pl-k">+</span> <span class="pl-c1">4</span>, <span class="pl-c1">true</span>);</td>
      </tr>
      <tr>
        <td id="L102" class="blob-num js-line-number" data-line-number="102"></td>
        <td id="LC102" class="blob-code blob-code-inner js-file-line">				<span class="pl-k">return</span> low <span class="pl-k">+</span> high <span class="pl-k">*</span> <span class="pl-c1">4294967296</span>;</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC105" class="blob-code blob-code-inner js-file-line">			<span class="pl-k">const</span> <span class="pl-c1">loadValue</span> <span class="pl-k">=</span> (<span class="pl-smi">addr</span>) <span class="pl-k">=&gt;</span> {</td>
      </tr>
      <tr>
        <td id="L106" class="blob-num js-line-number" data-line-number="106"></td>
        <td id="LC106" class="blob-code blob-code-inner js-file-line">				<span class="pl-k">const</span> <span class="pl-c1">f</span> <span class="pl-k">=</span> <span class="pl-en">mem</span>().<span class="pl-en">getFloat64</span>(addr, <span class="pl-c1">true</span>);</td>
      </tr>
      <tr>
        <td id="L107" class="blob-num js-line-number" data-line-number="107"></td>
        <td id="LC107" class="blob-code blob-code-inner js-file-line">				<span class="pl-k">if</span> (f <span class="pl-k">===</span> <span class="pl-c1">0</span>) {</td>
      </tr>
      <tr>
        <td id="L108" class="blob-num js-line-number" data-line-number="108"></td>
        <td id="LC108" class="blob-code blob-code-inner js-file-line">					<span class="pl-k">return</span> <span class="pl-c1">undefined</span>;</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC110" class="blob-code blob-code-inner js-file-line">				<span class="pl-k">if</span> (<span class="pl-k">!</span><span class="pl-c1">isNaN</span>(f)) {</td>
      </tr>
      <tr>
        <td id="L111" class="blob-num js-line-number" data-line-number="111"></td>
        <td id="LC111" class="blob-code blob-code-inner js-file-line">					<span class="pl-k">return</span> f;</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC114" class="blob-code blob-code-inner js-file-line">				<span class="pl-k">const</span> <span class="pl-c1">id</span> <span class="pl-k">=</span> <span class="pl-en">mem</span>().<span class="pl-en">getUint32</span>(addr, <span class="pl-c1">true</span>);</td>
      </tr>
      <tr>
        <td id="L115" class="blob-num js-line-number" data-line-number="115"></td>
        <td id="LC115" class="blob-code blob-code-inner js-file-line">				<span class="pl-k">return</span> <span class="pl-c1">this</span>.<span class="pl-smi">_values</span>[id];</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC118" class="blob-code blob-code-inner js-file-line">			<span class="pl-k">const</span> <span class="pl-c1">storeValue</span> <span class="pl-k">=</span> (<span class="pl-smi">addr</span>, <span class="pl-smi">v</span>) <span class="pl-k">=&gt;</span> {</td>
      </tr>
      <tr>
        <td id="L119" class="blob-num js-line-number" data-line-number="119"></td>
        <td id="LC119" class="blob-code blob-code-inner js-file-line">				<span class="pl-k">const</span> <span class="pl-c1">nanHead</span> <span class="pl-k">=</span> <span class="pl-c1">0x7FF80000</span>;</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC121" class="blob-code blob-code-inner js-file-line">				<span class="pl-k">if</span> (<span class="pl-k">typeof</span> v <span class="pl-k">===</span> <span class="pl-s"><span class="pl-pds">&quot;</span>number<span class="pl-pds">&quot;</span></span>) {</td>
      </tr>
      <tr>
        <td id="L122" class="blob-num js-line-number" data-line-number="122"></td>
        <td id="LC122" class="blob-code blob-code-inner js-file-line">					<span class="pl-k">if</span> (<span class="pl-c1">isNaN</span>(v)) {</td>
      </tr>
      <tr>
        <td id="L123" class="blob-num js-line-number" data-line-number="123"></td>
        <td id="LC123" class="blob-code blob-code-inner js-file-line">						<span class="pl-en">mem</span>().<span class="pl-en">setUint32</span>(addr <span class="pl-k">+</span> <span class="pl-c1">4</span>, nanHead, <span class="pl-c1">true</span>);</td>
      </tr>
      <tr>
        <td id="L124" class="blob-num js-line-number" data-line-number="124"></td>
        <td id="LC124" class="blob-code blob-code-inner js-file-line">						<span class="pl-en">mem</span>().<span class="pl-en">setUint32</span>(addr, <span class="pl-c1">0</span>, <span class="pl-c1">true</span>);</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC127" class="blob-code blob-code-inner js-file-line">					<span class="pl-k">if</span> (v <span class="pl-k">===</span> <span class="pl-c1">0</span>) {</td>
      </tr>
      <tr>
        <td id="L128" class="blob-num js-line-number" data-line-number="128"></td>
        <td id="LC128" class="blob-code blob-code-inner js-file-line">						<span class="pl-en">mem</span>().<span class="pl-en">setUint32</span>(addr <span class="pl-k">+</span> <span class="pl-c1">4</span>, nanHead, <span class="pl-c1">true</span>);</td>
      </tr>
      <tr>
        <td id="L129" class="blob-num js-line-number" data-line-number="129"></td>
        <td id="LC129" class="blob-code blob-code-inner js-file-line">						<span class="pl-en">mem</span>().<span class="pl-en">setUint32</span>(addr, <span class="pl-c1">1</span>, <span class="pl-c1">true</span>);</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC132" class="blob-code blob-code-inner js-file-line">					<span class="pl-en">mem</span>().<span class="pl-en">setFloat64</span>(addr, v, <span class="pl-c1">true</span>);</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC136" class="blob-code blob-code-inner js-file-line">				<span class="pl-k">switch</span> (v) {</td>
      </tr>
      <tr>
        <td id="L137" class="blob-num js-line-number" data-line-number="137"></td>
        <td id="LC137" class="blob-code blob-code-inner js-file-line">					<span class="pl-k">case</span> <span class="pl-c1">undefined</span>:</td>
      </tr>
      <tr>
        <td id="L138" class="blob-num js-line-number" data-line-number="138"></td>
        <td id="LC138" class="blob-code blob-code-inner js-file-line">						<span class="pl-en">mem</span>().<span class="pl-en">setFloat64</span>(addr, <span class="pl-c1">0</span>, <span class="pl-c1">true</span>);</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC140" class="blob-code blob-code-inner js-file-line">					<span class="pl-k">case</span> <span class="pl-c1">null</span>:</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC142" class="blob-code blob-code-inner js-file-line">						<span class="pl-en">mem</span>().<span class="pl-en">setUint32</span>(addr, <span class="pl-c1">2</span>, <span class="pl-c1">true</span>);</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC144" class="blob-code blob-code-inner js-file-line">					<span class="pl-k">case</span> <span class="pl-c1">true</span>:</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC146" class="blob-code blob-code-inner js-file-line">						<span class="pl-en">mem</span>().<span class="pl-en">setUint32</span>(addr, <span class="pl-c1">3</span>, <span class="pl-c1">true</span>);</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC148" class="blob-code blob-code-inner js-file-line">					<span class="pl-k">case</span> <span class="pl-c1">false</span>:</td>
      </tr>
      <tr>
        <td id="L149" class="blob-num js-line-number" data-line-number="149"></td>
        <td id="LC149" class="blob-code blob-code-inner js-file-line">						<span class="pl-en">mem</span>().<span class="pl-en">setUint32</span>(addr <span class="pl-k">+</span> <span class="pl-c1">4</span>, nanHead, <span class="pl-c1">true</span>);</td>
      </tr>
      <tr>
        <td id="L150" class="blob-num js-line-number" data-line-number="150"></td>
        <td id="LC150" class="blob-code blob-code-inner js-file-line">						<span class="pl-en">mem</span>().<span class="pl-en">setUint32</span>(addr, <span class="pl-c1">4</span>, <span class="pl-c1">true</span>);</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC154" class="blob-code blob-code-inner js-file-line">				<span class="pl-k">let</span> ref <span class="pl-k">=</span> <span class="pl-c1">this</span>.<span class="pl-smi">_refs</span>.<span class="pl-c1">get</span>(v);</td>
      </tr>
      <tr>
        <td id="L155" class="blob-num js-line-number" data-line-number="155"></td>
        <td id="LC155" class="blob-code blob-code-inner js-file-line">				<span class="pl-k">if</span> (ref <span class="pl-k">===</span> <span class="pl-c1">undefined</span>) {</td>
      </tr>
      <tr>
        <td id="L156" class="blob-num js-line-number" data-line-number="156"></td>
        <td id="LC156" class="blob-code blob-code-inner js-file-line">					ref <span class="pl-k">=</span> <span class="pl-c1">this</span>.<span class="pl-smi">_values</span>.<span class="pl-c1">length</span>;</td>
      </tr>
      <tr>
        <td id="L157" class="blob-num js-line-number" data-line-number="157"></td>
        <td id="LC157" class="blob-code blob-code-inner js-file-line">					<span class="pl-c1">this</span>.<span class="pl-smi">_values</span>.<span class="pl-c1">push</span>(v);</td>
      </tr>
      <tr>
        <td id="L158" class="blob-num js-line-number" data-line-number="158"></td>
        <td id="LC158" class="blob-code blob-code-inner js-file-line">					<span class="pl-c1">this</span>.<span class="pl-smi">_refs</span>.<span class="pl-c1">set</span>(v, ref);</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC160" class="blob-code blob-code-inner js-file-line">				<span class="pl-k">let</span> typeFlag <span class="pl-k">=</span> <span class="pl-c1">0</span>;</td>
      </tr>
      <tr>
        <td id="L161" class="blob-num js-line-number" data-line-number="161"></td>
        <td id="LC161" class="blob-code blob-code-inner js-file-line">				<span class="pl-k">switch</span> (<span class="pl-k">typeof</span> v) {</td>
      </tr>
      <tr>
        <td id="L162" class="blob-num js-line-number" data-line-number="162"></td>
        <td id="LC162" class="blob-code blob-code-inner js-file-line">					<span class="pl-k">case</span> <span class="pl-s"><span class="pl-pds">&quot;</span>string<span class="pl-pds">&quot;</span></span>:</td>
      </tr>
      <tr>
        <td id="L163" class="blob-num js-line-number" data-line-number="163"></td>
        <td id="LC163" class="blob-code blob-code-inner js-file-line">						typeFlag <span class="pl-k">=</span> <span class="pl-c1">1</span>;</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC165" class="blob-code blob-code-inner js-file-line">					<span class="pl-k">case</span> <span class="pl-s"><span class="pl-pds">&quot;</span>symbol<span class="pl-pds">&quot;</span></span>:</td>
      </tr>
      <tr>
        <td id="L166" class="blob-num js-line-number" data-line-number="166"></td>
        <td id="LC166" class="blob-code blob-code-inner js-file-line">						typeFlag <span class="pl-k">=</span> <span class="pl-c1">2</span>;</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC168" class="blob-code blob-code-inner js-file-line">					<span class="pl-k">case</span> <span class="pl-s"><span class="pl-pds">&quot;</span>function<span class="pl-pds">&quot;</span></span>:</td>
      </tr>
      <tr>
        <td id="L169" class="blob-num js-line-number" data-line-number="169"></td>
        <td id="LC169" class="blob-code blob-code-inner js-file-line">						typeFlag <span class="pl-k">=</span> <span class="pl-c1">3</span>;</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC172" class="blob-code blob-code-inner js-file-line">				<span class="pl-en">mem</span>().<span class="pl-en">setUint32</span>(addr <span class="pl-k">+</span> <span class="pl-c1">4</span>, nanHead <span class="pl-k">|</span> typeFlag, <span class="pl-c1">true</span>);</td>
      </tr>
      <tr>
        <td id="L173" class="blob-num js-line-number" data-line-number="173"></td>
        <td id="LC173" class="blob-code blob-code-inner js-file-line">				<span class="pl-en">mem</span>().<span class="pl-en">setUint32</span>(addr, ref, <span class="pl-c1">true</span>);</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC176" class="blob-code blob-code-inner js-file-line">			<span class="pl-k">const</span> <span class="pl-c1">loadSlice</span> <span class="pl-k">=</span> (<span class="pl-smi">addr</span>) <span class="pl-k">=&gt;</span> {</td>
      </tr>
      <tr>
        <td id="L177" class="blob-num js-line-number" data-line-number="177"></td>
        <td id="LC177" class="blob-code blob-code-inner js-file-line">				<span class="pl-k">const</span> <span class="pl-c1">array</span> <span class="pl-k">=</span> <span class="pl-en">getInt64</span>(addr <span class="pl-k">+</span> <span class="pl-c1">0</span>);</td>
      </tr>
      <tr>
        <td id="L178" class="blob-num js-line-number" data-line-number="178"></td>
        <td id="LC178" class="blob-code blob-code-inner js-file-line">				<span class="pl-k">const</span> <span class="pl-c1">len</span> <span class="pl-k">=</span> <span class="pl-en">getInt64</span>(addr <span class="pl-k">+</span> <span class="pl-c1">8</span>);</td>
      </tr>
      <tr>
        <td id="L179" class="blob-num js-line-number" data-line-number="179"></td>
        <td id="LC179" class="blob-code blob-code-inner js-file-line">				<span class="pl-k">return</span> <span class="pl-k">new</span> <span class="pl-en">Uint8Array</span>(<span class="pl-c1">this</span>.<span class="pl-smi">_inst</span>.<span class="pl-smi">exports</span>.<span class="pl-smi">mem</span>.<span class="pl-smi">buffer</span>, array, len);</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC182" class="blob-code blob-code-inner js-file-line">			<span class="pl-k">const</span> <span class="pl-c1">loadSliceOfValues</span> <span class="pl-k">=</span> (<span class="pl-smi">addr</span>) <span class="pl-k">=&gt;</span> {</td>
      </tr>
      <tr>
        <td id="L183" class="blob-num js-line-number" data-line-number="183"></td>
        <td id="LC183" class="blob-code blob-code-inner js-file-line">				<span class="pl-k">const</span> <span class="pl-c1">array</span> <span class="pl-k">=</span> <span class="pl-en">getInt64</span>(addr <span class="pl-k">+</span> <span class="pl-c1">0</span>);</td>
      </tr>
      <tr>
        <td id="L184" class="blob-num js-line-number" data-line-number="184"></td>
        <td id="LC184" class="blob-code blob-code-inner js-file-line">				<span class="pl-k">const</span> <span class="pl-c1">len</span> <span class="pl-k">=</span> <span class="pl-en">getInt64</span>(addr <span class="pl-k">+</span> <span class="pl-c1">8</span>);</td>
      </tr>
      <tr>
        <td id="L185" class="blob-num js-line-number" data-line-number="185"></td>
        <td id="LC185" class="blob-code blob-code-inner js-file-line">				<span class="pl-k">const</span> <span class="pl-c1">a</span> <span class="pl-k">=</span> <span class="pl-k">new</span> <span class="pl-en">Array</span>(len);</td>
      </tr>
      <tr>
        <td id="L186" class="blob-num js-line-number" data-line-number="186"></td>
        <td id="LC186" class="blob-code blob-code-inner js-file-line">				<span class="pl-k">for</span> (<span class="pl-k">let</span> i <span class="pl-k">=</span> <span class="pl-c1">0</span>; i <span class="pl-k">&lt;</span> len; i<span class="pl-k">++</span>) {</td>
      </tr>
      <tr>
        <td id="L187" class="blob-num js-line-number" data-line-number="187"></td>
        <td id="LC187" class="blob-code blob-code-inner js-file-line">					a[i] <span class="pl-k">=</span> <span class="pl-en">loadValue</span>(array <span class="pl-k">+</span> i <span class="pl-k">*</span> <span class="pl-c1">8</span>);</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC189" class="blob-code blob-code-inner js-file-line">				<span class="pl-k">return</span> a;</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC192" class="blob-code blob-code-inner js-file-line">			<span class="pl-k">const</span> <span class="pl-c1">loadString</span> <span class="pl-k">=</span> (<span class="pl-smi">addr</span>) <span class="pl-k">=&gt;</span> {</td>
      </tr>
      <tr>
        <td id="L193" class="blob-num js-line-number" data-line-number="193"></td>
        <td id="LC193" class="blob-code blob-code-inner js-file-line">				<span class="pl-k">const</span> <span class="pl-c1">saddr</span> <span class="pl-k">=</span> <span class="pl-en">getInt64</span>(addr <span class="pl-k">+</span> <span class="pl-c1">0</span>);</td>
      </tr>
      <tr>
        <td id="L194" class="blob-num js-line-number" data-line-number="194"></td>
        <td id="LC194" class="blob-code blob-code-inner js-file-line">				<span class="pl-k">const</span> <span class="pl-c1">len</span> <span class="pl-k">=</span> <span class="pl-en">getInt64</span>(addr <span class="pl-k">+</span> <span class="pl-c1">8</span>);</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC198" class="blob-code blob-code-inner js-file-line">			<span class="pl-k">const</span> <span class="pl-c1">timeOrigin</span> <span class="pl-k">=</span> <span class="pl-c1">Date</span>.<span class="pl-en">now</span>() <span class="pl-k">-</span> <span class="pl-c1">performance</span>.<span class="pl-en">now</span>();</td>
      </tr>
      <tr>
        <td id="L199" class="blob-num js-line-number" data-line-number="199"></td>
        <td id="LC199" class="blob-code blob-code-inner js-file-line">			<span class="pl-c1">this</span>.<span class="pl-smi">importObject</span> <span class="pl-k">=</span> {</td>
      </tr>
      <tr>
        <td id="L200" class="blob-num js-line-number" data-line-number="200"></td>
        <td id="LC200" class="blob-code blob-code-inner js-file-line">				go<span class="pl-k">:</span> {</td>
      </tr>
      <tr>
        <td id="L201" class="blob-num js-line-number" data-line-number="201"></td>
        <td id="LC201" class="blob-code blob-code-inner js-file-line">					<span class="pl-c"><span class="pl-c">//</span> Go&#39;s SP does not change as long as no Go code is running. Some operations (e.g. calls, getters and setters)</span></td>
      </tr>
      <tr>
        <td id="L202" class="blob-num js-line-number" data-line-number="202"></td>
        <td id="LC202" class="blob-code blob-code-inner js-file-line">					<span class="pl-c"><span class="pl-c">//</span> may trigger a synchronous callback to Go. This makes Go code get executed in the middle of the imported</span></td>
      </tr>
      <tr>
        <td id="L203" class="blob-num js-line-number" data-line-number="203"></td>
        <td id="LC203" class="blob-code blob-code-inner js-file-line">					<span class="pl-c"><span class="pl-c">//</span> function. A goroutine can switch to a new stack if the current stack is too small (see morestack function).</span></td>
      </tr>
      <tr>
        <td id="L204" class="blob-num js-line-number" data-line-number="204"></td>
        <td id="LC204" class="blob-code blob-code-inner js-file-line">					<span class="pl-c"><span class="pl-c">//</span> This changes the SP, thus we have to update the SP used by the imported function.</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC206" class="blob-code blob-code-inner js-file-line">					<span class="pl-c"><span class="pl-c">//</span> func wasmExit(code int32)</span></td>
      </tr>
      <tr>
        <td id="L207" class="blob-num js-line-number" data-line-number="207"></td>
        <td id="LC207" class="blob-code blob-code-inner js-file-line">					<span class="pl-s"><span class="pl-pds">&quot;</span><span class="pl-en">runtime.wasmExit</span><span class="pl-pds">&quot;</span></span><span class="pl-k">:</span> (<span class="pl-smi">sp</span>) <span class="pl-k">=&gt;</span> {</td>
      </tr>
      <tr>
        <td id="L208" class="blob-num js-line-number" data-line-number="208"></td>
        <td id="LC208" class="blob-code blob-code-inner js-file-line">						<span class="pl-k">const</span> <span class="pl-c1">code</span> <span class="pl-k">=</span> <span class="pl-en">mem</span>().<span class="pl-en">getInt32</span>(sp <span class="pl-k">+</span> <span class="pl-c1">8</span>, <span class="pl-c1">true</span>);</td>
      </tr>
      <tr>
        <td id="L209" class="blob-num js-line-number" data-line-number="209"></td>
        <td id="LC209" class="blob-code blob-code-inner js-file-line">						<span class="pl-c1">this</span>.<span class="pl-smi">exited</span> <span class="pl-k">=</span> <span class="pl-c1">true</span>;</td>
      </tr>
      <tr>
        <td id="L210" class="blob-num js-line-number" data-line-number="210"></td>
        <td id="LC210" class="blob-code blob-code-inner js-file-line">						<span class="pl-k">delete</span> <span class="pl-c1">this</span>.<span class="pl-smi">_inst</span>;</td>
      </tr>
      <tr>
        <td id="L211" class="blob-num js-line-number" data-line-number="211"></td>
        <td id="LC211" class="blob-code blob-code-inner js-file-line">						<span class="pl-k">delete</span> <span class="pl-c1">this</span>.<span class="pl-smi">_values</span>;</td>
      </tr>
      <tr>
        <td id="L212" class="blob-num js-line-number" data-line-number="212"></td>
        <td id="LC212" class="blob-code blob-code-inner js-file-line">						<span class="pl-k">delete</span> <span class="pl-c1">this</span>.<span class="pl-smi">_refs</span>;</td>
      </tr>
      <tr>
        <td id="L213" class="blob-num js-line-number" data-line-number="213"></td>
        <td id="LC213" class="blob-code blob-code-inner js-file-line">						<span class="pl-c1">this</span>.<span class="pl-en">exit</span>(code);</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC216" class="blob-code blob-code-inner js-file-line">					<span class="pl-c"><span class="pl-c">//</span> func wasmWrite(fd uintptr, p unsafe.Pointer, n int32)</span></td>
      </tr>
      <tr>
        <td id="L217" class="blob-num js-line-number" data-line-number="217"></td>
        <td id="LC217" class="blob-code blob-code-inner js-file-line">					<span class="pl-s"><span class="pl-pds">&quot;</span><span class="pl-en">runtime.wasmWrite</span><span class="pl-pds">&quot;</span></span><span class="pl-k">:</span> (<span class="pl-smi">sp</span>) <span class="pl-k">=&gt;</span> {</td>
      </tr>
      <tr>
        <td id="L218" class="blob-num js-line-number" data-line-number="218"></td>
        <td id="LC218" class="blob-code blob-code-inner js-file-line">						<span class="pl-k">const</span> <span class="pl-c1">fd</span> <span class="pl-k">=</span> <span class="pl-en">getInt64</span>(sp <span class="pl-k">+</span> <span class="pl-c1">8</span>);</td>
      </tr>
      <tr>
        <td id="L219" class="blob-num js-line-number" data-line-number="219"></td>
        <td id="LC219" class="blob-code blob-code-inner js-file-line">						<span class="pl-k">const</span> <span class="pl-c1">p</span> <span class="pl-k">=</span> <span class="pl-en">getInt64</span>(sp <span class="pl-k">+</span> <span class="pl-c1">16</span>);</td>
      </tr>
      <tr>
        <td id="L220" class="blob-num js-line-number" data-line-number="220"></td>
        <td id="LC220" class="blob-code blob-code-inner js-file-line">						<span class="pl-k">const</span> <span class="pl-c1">n</span> <span class="pl-k">=</span> <span class="pl-en">mem</span>().<span class="pl-en">getInt32</span>(sp <span class="pl-k">+</span> <span class="pl-c1">24</span>, <span class="pl-c1">true</span>);</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC224" class="blob-code blob-code-inner js-file-line">					<span class="pl-c"><span class="pl-c">//</span> func nanotime() int64</span></td>
      </tr>
      <tr>
        <td id="L225" class="blob-num js-line-number" data-line-number="225"></td>
        <td id="LC225" class="blob-code blob-code-inner js-file-line">					<span class="pl-s"><span class="pl-pds">&quot;</span><span class="pl-en">runtime.nanotime</span><span class="pl-pds">&quot;</span></span><span class="pl-k">:</span> (<span class="pl-smi">sp</span>) <span class="pl-k">=&gt;</span> {</td>
      </tr>
      <tr>
        <td id="L226" class="blob-num js-line-number" data-line-number="226"></td>
        <td id="LC226" class="blob-code blob-code-inner js-file-line">						<span class="pl-en">setInt64</span>(sp <span class="pl-k">+</span> <span class="pl-c1">8</span>, (timeOrigin <span class="pl-k">+</span> <span class="pl-c1">performance</span>.<span class="pl-en">now</span>()) <span class="pl-k">*</span> <span class="pl-c1">1000000</span>);</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC229" class="blob-code blob-code-inner js-file-line">					<span class="pl-c"><span class="pl-c">//</span> func walltime() (sec int64, nsec int32)</span></td>
      </tr>
      <tr>
        <td id="L230" class="blob-num js-line-number" data-line-number="230"></td>
        <td id="LC230" class="blob-code blob-code-inner js-file-line">					<span class="pl-s"><span class="pl-pds">&quot;</span><span class="pl-en">runtime.walltime</span><span class="pl-pds">&quot;</span></span><span class="pl-k">:</span> (<span class="pl-smi">sp</span>) <span class="pl-k">=&gt;</span> {</td>
      </tr>
      <tr>
        <td id="L231" class="blob-num js-line-number" data-line-number="231"></td>
        <td id="LC231" class="blob-code blob-code-inner js-file-line">						<span class="pl-k">const</span> <span class="pl-c1">msec</span> <span class="pl-k">=</span> (<span class="pl-k">new</span> <span class="pl-en">Date</span>).<span class="pl-c1">getTime</span>();</td>
      </tr>
      <tr>
        <td id="L232" class="blob-num js-line-number" data-line-number="232"></td>
        <td id="LC232" class="blob-code blob-code-inner js-file-line">						<span class="pl-en">setInt64</span>(sp <span class="pl-k">+</span> <span class="pl-c1">8</span>, msec <span class="pl-k">/</span> <span class="pl-c1">1000</span>);</td>
      </tr>
      <tr>
        <td id="L233" class="blob-num js-line-number" data-line-number="233"></td>
        <td id="LC233" class="blob-code blob-code-inner js-file-line">						<span class="pl-en">mem</span>().<span class="pl-en">setInt32</span>(sp <span class="pl-k">+</span> <span class="pl-c1">16</span>, (msec <span class="pl-k">%</span> <span class="pl-c1">1000</span>) <span class="pl-k">*</span> <span class="pl-c1">1000000</span>, <span class="pl-c1">true</span>);</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC236" class="blob-code blob-code-inner js-file-line">					<span class="pl-c"><span class="pl-c">//</span> func scheduleCallback(delay int64) int32</span></td>
      </tr>
      <tr>
        <td id="L237" class="blob-num js-line-number" data-line-number="237"></td>
        <td id="LC237" class="blob-code blob-code-inner js-file-line">					<span class="pl-s"><span class="pl-pds">&quot;</span><span class="pl-en">runtime.scheduleCallback</span><span class="pl-pds">&quot;</span></span><span class="pl-k">:</span> (<span class="pl-smi">sp</span>) <span class="pl-k">=&gt;</span> {</td>
      </tr>
      <tr>
        <td id="L238" class="blob-num js-line-number" data-line-number="238"></td>
        <td id="LC238" class="blob-code blob-code-inner js-file-line">						<span class="pl-k">const</span> <span class="pl-c1">id</span> <span class="pl-k">=</span> <span class="pl-c1">this</span>.<span class="pl-smi">_nextCallbackTimeoutID</span>;</td>
      </tr>
      <tr>
        <td id="L239" class="blob-num js-line-number" data-line-number="239"></td>
        <td id="LC239" class="blob-code blob-code-inner js-file-line">						<span class="pl-c1">this</span>.<span class="pl-smi">_nextCallbackTimeoutID</span><span class="pl-k">++</span>;</td>
      </tr>
      <tr>
        <td id="L240" class="blob-num js-line-number" data-line-number="240"></td>
        <td id="LC240" class="blob-code blob-code-inner js-file-line">						<span class="pl-c1">this</span>.<span class="pl-smi">_callbackTimeouts</span>.<span class="pl-c1">set</span>(id, <span class="pl-c1">setTimeout</span>(</td>
      </tr>
      <tr>
        <td id="L241" class="blob-num js-line-number" data-line-number="241"></td>
        <td id="LC241" class="blob-code blob-code-inner js-file-line">							() <span class="pl-k">=&gt;</span> { <span class="pl-c1">this</span>.<span class="pl-en">_resume</span>(); },</td>
      </tr>
      <tr>
        <td id="L242" class="blob-num js-line-number" data-line-number="242"></td>
        <td id="LC242" class="blob-code blob-code-inner js-file-line">							<span class="pl-en">getInt64</span>(sp <span class="pl-k">+</span> <span class="pl-c1">8</span>) <span class="pl-k">+</span> <span class="pl-c1">1</span>, <span class="pl-c"><span class="pl-c">//</span> setTimeout has been seen to fire up to 1 millisecond early</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC244" class="blob-code blob-code-inner js-file-line">						<span class="pl-en">mem</span>().<span class="pl-en">setInt32</span>(sp <span class="pl-k">+</span> <span class="pl-c1">16</span>, id, <span class="pl-c1">true</span>);</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC247" class="blob-code blob-code-inner js-file-line">					<span class="pl-c"><span class="pl-c">//</span> func clearScheduledCallback(id int32)</span></td>
      </tr>
      <tr>
        <td id="L248" class="blob-num js-line-number" data-line-number="248"></td>
        <td id="LC248" class="blob-code blob-code-inner js-file-line">					<span class="pl-s"><span class="pl-pds">&quot;</span><span class="pl-en">runtime.clearScheduledCallback</span><span class="pl-pds">&quot;</span></span><span class="pl-k">:</span> (<span class="pl-smi">sp</span>) <span class="pl-k">=&gt;</span> {</td>
      </tr>
      <tr>
        <td id="L249" class="blob-num js-line-number" data-line-number="249"></td>
        <td id="LC249" class="blob-code blob-code-inner js-file-line">						<span class="pl-k">const</span> <span class="pl-c1">id</span> <span class="pl-k">=</span> <span class="pl-en">mem</span>().<span class="pl-en">getInt32</span>(sp <span class="pl-k">+</span> <span class="pl-c1">8</span>, <span class="pl-c1">true</span>);</td>
      </tr>
      <tr>
        <td id="L250" class="blob-num js-line-number" data-line-number="250"></td>
        <td id="LC250" class="blob-code blob-code-inner js-file-line">						<span class="pl-c1">clearTimeout</span>(<span class="pl-c1">this</span>.<span class="pl-smi">_callbackTimeouts</span>.<span class="pl-c1">get</span>(id));</td>
      </tr>
      <tr>
        <td id="L251" class="blob-num js-line-number" data-line-number="251"></td>
        <td id="LC251" class="blob-code blob-code-inner js-file-line">						<span class="pl-c1">this</span>.<span class="pl-smi">_callbackTimeouts</span>.<span class="pl-c1">delete</span>(id);</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC254" class="blob-code blob-code-inner js-file-line">					<span class="pl-c"><span class="pl-c">//</span> func getRandomData(r []byte)</span></td>
      </tr>
      <tr>
        <td id="L255" class="blob-num js-line-number" data-line-number="255"></td>
        <td id="LC255" class="blob-code blob-code-inner js-file-line">					<span class="pl-s"><span class="pl-pds">&quot;</span><span class="pl-en">runtime.getRandomData</span><span class="pl-pds">&quot;</span></span><span class="pl-k">:</span> (<span class="pl-smi">sp</span>) <span class="pl-k">=&gt;</span> {</td>
      </tr>
      <tr>
        <td id="L256" class="blob-num js-line-number" data-line-number="256"></td>
        <td id="LC256" class="blob-code blob-code-inner js-file-line">						<span class="pl-smi">crypto</span>.<span class="pl-en">getRandomValues</span>(<span class="pl-en">loadSlice</span>(sp <span class="pl-k">+</span> <span class="pl-c1">8</span>));</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC259" class="blob-code blob-code-inner js-file-line">					<span class="pl-c"><span class="pl-c">//</span> func stringVal(value string) ref</span></td>
      </tr>
      <tr>
        <td id="L260" class="blob-num js-line-number" data-line-number="260"></td>
        <td id="LC260" class="blob-code blob-code-inner js-file-line">					<span class="pl-s"><span class="pl-pds">&quot;</span><span class="pl-en">syscall/js.stringVal</span><span class="pl-pds">&quot;</span></span><span class="pl-k">:</span> (<span class="pl-smi">sp</span>) <span class="pl-k">=&gt;</span> {</td>
      </tr>
      <tr>
        <td id="L261" class="blob-num js-line-number" data-line-number="261"></td>
        <td id="LC261" class="blob-code blob-code-inner js-file-line">						<span class="pl-en">storeValue</span>(sp <span class="pl-k">+</span> <span class="pl-c1">24</span>, <span class="pl-en">loadString</span>(sp <span class="pl-k">+</span> <span class="pl-c1">8</span>));</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC264" class="blob-code blob-code-inner js-file-line">					<span class="pl-c"><span class="pl-c">//</span> func valueGet(v ref, p string) ref</span></td>
      </tr>
      <tr>
        <td id="L265" class="blob-num js-line-number" data-line-number="265"></td>
        <td id="LC265" class="blob-code blob-code-inner js-file-line">					<span class="pl-s"><span class="pl-pds">&quot;</span><span class="pl-en">syscall/js.valueGet</span><span class="pl-pds">&quot;</span></span><span class="pl-k">:</span> (<span class="pl-smi">sp</span>) <span class="pl-k">=&gt;</span> {</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC267" class="blob-code blob-code-inner js-file-line">						sp <span class="pl-k">=</span> <span class="pl-c1">this</span>.<span class="pl-smi">_inst</span>.<span class="pl-smi">exports</span>.<span class="pl-en">getsp</span>(); <span class="pl-c"><span class="pl-c">//</span> see comment above</span></td>
      </tr>
      <tr>
        <td id="L268" class="blob-num js-line-number" data-line-number="268"></td>
        <td id="LC268" class="blob-code blob-code-inner js-file-line">						<span class="pl-en">storeValue</span>(sp <span class="pl-k">+</span> <span class="pl-c1">32</span>, result);</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC271" class="blob-code blob-code-inner js-file-line">					<span class="pl-c"><span class="pl-c">//</span> func valueSet(v ref, p string, x ref)</span></td>
      </tr>
      <tr>
        <td id="L272" class="blob-num js-line-number" data-line-number="272"></td>
        <td id="LC272" class="blob-code blob-code-inner js-file-line">					<span class="pl-s"><span class="pl-pds">&quot;</span><span class="pl-en">syscall/js.valueSet</span><span class="pl-pds">&quot;</span></span><span class="pl-k">:</span> (<span class="pl-smi">sp</span>) <span class="pl-k">=&gt;</span> {</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC276" class="blob-code blob-code-inner js-file-line">					<span class="pl-c"><span class="pl-c">//</span> func valueIndex(v ref, i int) ref</span></td>
      </tr>
      <tr>
        <td id="L277" class="blob-num js-line-number" data-line-number="277"></td>
        <td id="LC277" class="blob-code blob-code-inner js-file-line">					<span class="pl-s"><span class="pl-pds">&quot;</span><span class="pl-en">syscall/js.valueIndex</span><span class="pl-pds">&quot;</span></span><span class="pl-k">:</span> (<span class="pl-smi">sp</span>) <span class="pl-k">=&gt;</span> {</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC281" class="blob-code blob-code-inner js-file-line">					<span class="pl-c"><span class="pl-c">//</span> valueSetIndex(v ref, i int, x ref)</span></td>
      </tr>
      <tr>
        <td id="L282" class="blob-num js-line-number" data-line-number="282"></td>
        <td id="LC282" class="blob-code blob-code-inner js-file-line">					<span class="pl-s"><span class="pl-pds">&quot;</span><span class="pl-en">syscall/js.valueSetIndex</span><span class="pl-pds">&quot;</span></span><span class="pl-k">:</span> (<span class="pl-smi">sp</span>) <span class="pl-k">=&gt;</span> {</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC286" class="blob-code blob-code-inner js-file-line">					<span class="pl-c"><span class="pl-c">//</span> func valueCall(v ref, m string, args []ref) (ref, bool)</span></td>
      </tr>
      <tr>
        <td id="L287" class="blob-num js-line-number" data-line-number="287"></td>
        <td id="LC287" class="blob-code blob-code-inner js-file-line">					<span class="pl-s"><span class="pl-pds">&quot;</span><span class="pl-en">syscall/js.valueCall</span><span class="pl-pds">&quot;</span></span><span class="pl-k">:</span> (<span class="pl-smi">sp</span>) <span class="pl-k">=&gt;</span> {</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC289" class="blob-code blob-code-inner js-file-line">							<span class="pl-k">const</span> <span class="pl-c1">v</span> <span class="pl-k">=</span> <span class="pl-en">loadValue</span>(sp <span class="pl-k">+</span> <span class="pl-c1">8</span>);</td>
      </tr>
      <tr>
        <td id="L290" class="blob-num js-line-number" data-line-number="290"></td>
        <td id="LC290" class="blob-code blob-code-inner js-file-line">							<span class="pl-k">const</span> <span class="pl-c1">m</span> <span class="pl-k">=</span> <span class="pl-c1">Reflect</span>.<span class="pl-c1">get</span>(v, <span class="pl-en">loadString</span>(sp <span class="pl-k">+</span> <span class="pl-c1">16</span>));</td>
      </tr>
      <tr>
        <td id="L291" class="blob-num js-line-number" data-line-number="291"></td>
        <td id="LC291" class="blob-code blob-code-inner js-file-line">							<span class="pl-k">const</span> <span class="pl-c1">args</span> <span class="pl-k">=</span> <span class="pl-en">loadSliceOfValues</span>(sp <span class="pl-k">+</span> <span class="pl-c1">32</span>);</td>
      </tr>
      <tr>
        <td id="L292" class="blob-num js-line-number" data-line-number="292"></td>
        <td id="LC292" class="blob-code blob-code-inner js-file-line">							<span class="pl-k">const</span> <span class="pl-c1">result</span> <span class="pl-k">=</span> <span class="pl-c1">Reflect</span>.<span class="pl-c1">apply</span>(m, v, args);</td>
      </tr>
      <tr>
        <td id="L293" class="blob-num js-line-number" data-line-number="293"></td>
        <td id="LC293" class="blob-code blob-code-inner js-file-line">							sp <span class="pl-k">=</span> <span class="pl-c1">this</span>.<span class="pl-smi">_inst</span>.<span class="pl-smi">exports</span>.<span class="pl-en">getsp</span>(); <span class="pl-c"><span class="pl-c">//</span> see comment above</span></td>
      </tr>
      <tr>
        <td id="L294" class="blob-num js-line-number" data-line-number="294"></td>
        <td id="LC294" class="blob-code blob-code-inner js-file-line">							<span class="pl-en">storeValue</span>(sp <span class="pl-k">+</span> <span class="pl-c1">56</span>, result);</td>
      </tr>
      <tr>
        <td id="L295" class="blob-num js-line-number" data-line-number="295"></td>
        <td id="LC295" class="blob-code blob-code-inner js-file-line">							<span class="pl-en">mem</span>().<span class="pl-en">setUint8</span>(sp <span class="pl-k">+</span> <span class="pl-c1">64</span>, <span class="pl-c1">1</span>);</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC297" class="blob-code blob-code-inner js-file-line">							<span class="pl-en">storeValue</span>(sp <span class="pl-k">+</span> <span class="pl-c1">56</span>, err);</td>
      </tr>
      <tr>
        <td id="L298" class="blob-num js-line-number" data-line-number="298"></td>
        <td id="LC298" class="blob-code blob-code-inner js-file-line">							<span class="pl-en">mem</span>().<span class="pl-en">setUint8</span>(sp <span class="pl-k">+</span> <span class="pl-c1">64</span>, <span class="pl-c1">0</span>);</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC302" class="blob-code blob-code-inner js-file-line">					<span class="pl-c"><span class="pl-c">//</span> func valueInvoke(v ref, args []ref) (ref, bool)</span></td>
      </tr>
      <tr>
        <td id="L303" class="blob-num js-line-number" data-line-number="303"></td>
        <td id="LC303" class="blob-code blob-code-inner js-file-line">					<span class="pl-s"><span class="pl-pds">&quot;</span><span class="pl-en">syscall/js.valueInvoke</span><span class="pl-pds">&quot;</span></span><span class="pl-k">:</span> (<span class="pl-smi">sp</span>) <span class="pl-k">=&gt;</span> {</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC307" class="blob-code blob-code-inner js-file-line">							<span class="pl-k">const</span> <span class="pl-c1">result</span> <span class="pl-k">=</span> <span class="pl-c1">Reflect</span>.<span class="pl-c1">apply</span>(v, <span class="pl-c1">undefined</span>, args);</td>
      </tr>
      <tr>
        <td id="L308" class="blob-num js-line-number" data-line-number="308"></td>
        <td id="LC308" class="blob-code blob-code-inner js-file-line">							sp <span class="pl-k">=</span> <span class="pl-c1">this</span>.<span class="pl-smi">_inst</span>.<span class="pl-smi">exports</span>.<span class="pl-en">getsp</span>(); <span class="pl-c"><span class="pl-c">//</span> see comment above</span></td>
      </tr>
      <tr>
        <td id="L309" class="blob-num js-line-number" data-line-number="309"></td>
        <td id="LC309" class="blob-code blob-code-inner js-file-line">							<span class="pl-en">storeValue</span>(sp <span class="pl-k">+</span> <span class="pl-c1">40</span>, result);</td>
      </tr>
      <tr>
        <td id="L310" class="blob-num js-line-number" data-line-number="310"></td>
        <td id="LC310" class="blob-code blob-code-inner js-file-line">							<span class="pl-en">mem</span>().<span class="pl-en">setUint8</span>(sp <span class="pl-k">+</span> <span class="pl-c1">48</span>, <span class="pl-c1">1</span>);</td>
      </tr>
      <tr>
        <td id="L311" class="blob-num js-line-number" data-line-number="311"></td>
        <td id="LC311" class="blob-code blob-code-inner js-file-line">						} <span class="pl-k">catch</span> (err) {</td>
      </tr>
      <tr>
        <td id="L312" class="blob-num js-line-number" data-line-number="312"></td>
        <td id="LC312" class="blob-code blob-code-inner js-file-line">							<span class="pl-en">storeValue</span>(sp <span class="pl-k">+</span> <span class="pl-c1">40</span>, err);</td>
      </tr>
      <tr>
        <td id="L313" class="blob-num js-line-number" data-line-number="313"></td>
        <td id="LC313" class="blob-code blob-code-inner js-file-line">							<span class="pl-en">mem</span>().<span class="pl-en">setUint8</span>(sp <span class="pl-k">+</span> <span class="pl-c1">48</span>, <span class="pl-c1">0</span>);</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC317" class="blob-code blob-code-inner js-file-line">					<span class="pl-c"><span class="pl-c">//</span> func valueNew(v ref, args []ref) (ref, bool)</span></td>
      </tr>
      <tr>
        <td id="L318" class="blob-num js-line-number" data-line-number="318"></td>
        <td id="LC318" class="blob-code blob-code-inner js-file-line">					<span class="pl-s"><span class="pl-pds">&quot;</span><span class="pl-en">syscall/js.valueNew</span><span class="pl-pds">&quot;</span></span><span class="pl-k">:</span> (<span class="pl-smi">sp</span>) <span class="pl-k">=&gt;</span> {</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC320" class="blob-code blob-code-inner js-file-line">							<span class="pl-k">const</span> <span class="pl-c1">v</span> <span class="pl-k">=</span> <span class="pl-en">loadValue</span>(sp <span class="pl-k">+</span> <span class="pl-c1">8</span>);</td>
      </tr>
      <tr>
        <td id="L321" class="blob-num js-line-number" data-line-number="321"></td>
        <td id="LC321" class="blob-code blob-code-inner js-file-line">							<span class="pl-k">const</span> <span class="pl-c1">args</span> <span class="pl-k">=</span> <span class="pl-en">loadSliceOfValues</span>(sp <span class="pl-k">+</span> <span class="pl-c1">16</span>);</td>
      </tr>
      <tr>
        <td id="L322" class="blob-num js-line-number" data-line-number="322"></td>
        <td id="LC322" class="blob-code blob-code-inner js-file-line">							<span class="pl-k">const</span> <span class="pl-c1">result</span> <span class="pl-k">=</span> <span class="pl-c1">Reflect</span>.<span class="pl-en">construct</span>(v, args);</td>
      </tr>
      <tr>
        <td id="L323" class="blob-num js-line-number" data-line-number="323"></td>
        <td id="LC323" class="blob-code blob-code-inner js-file-line">							sp <span class="pl-k">=</span> <span class="pl-c1">this</span>.<span class="pl-smi">_inst</span>.<span class="pl-smi">exports</span>.<span class="pl-en">getsp</span>(); <span class="pl-c"><span class="pl-c">//</span> see comment above</span></td>
      </tr>
      <tr>
        <td id="L324" class="blob-num js-line-number" data-line-number="324"></td>
        <td id="LC324" class="blob-code blob-code-inner js-file-line">							<span class="pl-en">storeValue</span>(sp <span class="pl-k">+</span> <span class="pl-c1">40</span>, result);</td>
      </tr>
      <tr>
        <td id="L325" class="blob-num js-line-number" data-line-number="325"></td>
        <td id="LC325" class="blob-code blob-code-inner js-file-line">							<span class="pl-en">mem</span>().<span class="pl-en">setUint8</span>(sp <span class="pl-k">+</span> <span class="pl-c1">48</span>, <span class="pl-c1">1</span>);</td>
      </tr>
      <tr>
        <td id="L326" class="blob-num js-line-number" data-line-number="326"></td>
        <td id="LC326" class="blob-code blob-code-inner js-file-line">						} <span class="pl-k">catch</span> (err) {</td>
      </tr>
      <tr>
        <td id="L327" class="blob-num js-line-number" data-line-number="327"></td>
        <td id="LC327" class="blob-code blob-code-inner js-file-line">							<span class="pl-en">storeValue</span>(sp <span class="pl-k">+</span> <span class="pl-c1">40</span>, err);</td>
      </tr>
      <tr>
        <td id="L328" class="blob-num js-line-number" data-line-number="328"></td>
        <td id="LC328" class="blob-code blob-code-inner js-file-line">							<span class="pl-en">mem</span>().<span class="pl-en">setUint8</span>(sp <span class="pl-k">+</span> <span class="pl-c1">48</span>, <span class="pl-c1">0</span>);</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC332" class="blob-code blob-code-inner js-file-line">					<span class="pl-c"><span class="pl-c">//</span> func valueLength(v ref) int</span></td>
      </tr>
      <tr>
        <td id="L333" class="blob-num js-line-number" data-line-number="333"></td>
        <td id="LC333" class="blob-code blob-code-inner js-file-line">					<span class="pl-s"><span class="pl-pds">&quot;</span><span class="pl-en">syscall/js.valueLength</span><span class="pl-pds">&quot;</span></span><span class="pl-k">:</span> (<span class="pl-smi">sp</span>) <span class="pl-k">=&gt;</span> {</td>
      </tr>
      <tr>
        <td id="L334" class="blob-num js-line-number" data-line-number="334"></td>
        <td id="LC334" class="blob-code blob-code-inner js-file-line">						<span class="pl-en">setInt64</span>(sp <span class="pl-k">+</span> <span class="pl-c1">16</span>, <span class="pl-c1">parseInt</span>(<span class="pl-en">loadValue</span>(sp <span class="pl-k">+</span> <span class="pl-c1">8</span>).<span class="pl-c1">length</span>));</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC337" class="blob-code blob-code-inner js-file-line">					<span class="pl-c"><span class="pl-c">//</span> valuePrepareString(v ref) (ref, int)</span></td>
      </tr>
      <tr>
        <td id="L338" class="blob-num js-line-number" data-line-number="338"></td>
        <td id="LC338" class="blob-code blob-code-inner js-file-line">					<span class="pl-s"><span class="pl-pds">&quot;</span><span class="pl-en">syscall/js.valuePrepareString</span><span class="pl-pds">&quot;</span></span><span class="pl-k">:</span> (<span class="pl-smi">sp</span>) <span class="pl-k">=&gt;</span> {</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC340" class="blob-code blob-code-inner js-file-line">						<span class="pl-en">storeValue</span>(sp <span class="pl-k">+</span> <span class="pl-c1">16</span>, str);</td>
      </tr>
      <tr>
        <td id="L341" class="blob-num js-line-number" data-line-number="341"></td>
        <td id="LC341" class="blob-code blob-code-inner js-file-line">						<span class="pl-en">setInt64</span>(sp <span class="pl-k">+</span> <span class="pl-c1">24</span>, <span class="pl-smi">str</span>.<span class="pl-c1">length</span>);</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC344" class="blob-code blob-code-inner js-file-line">					<span class="pl-c"><span class="pl-c">//</span> valueLoadString(v ref, b []byte)</span></td>
      </tr>
      <tr>
        <td id="L345" class="blob-num js-line-number" data-line-number="345"></td>
        <td id="LC345" class="blob-code blob-code-inner js-file-line">					<span class="pl-s"><span class="pl-pds">&quot;</span><span class="pl-en">syscall/js.valueLoadString</span><span class="pl-pds">&quot;</span></span><span class="pl-k">:</span> (<span class="pl-smi">sp</span>) <span class="pl-k">=&gt;</span> {</td>
      </tr>
      <tr>
        <td id="L346" class="blob-num js-line-number" data-line-number="346"></td>
        <td id="LC346" class="blob-code blob-code-inner js-file-line">						<span class="pl-k">const</span> <span class="pl-c1">str</span> <span class="pl-k">=</span> <span class="pl-en">loadValue</span>(sp <span class="pl-k">+</span> <span class="pl-c1">8</span>);</td>
      </tr>
      <tr>
        <td id="L347" class="blob-num js-line-number" data-line-number="347"></td>
        <td id="LC347" class="blob-code blob-code-inner js-file-line">						<span class="pl-en">loadSlice</span>(sp <span class="pl-k">+</span> <span class="pl-c1">16</span>).<span class="pl-c1">set</span>(str);</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC350" class="blob-code blob-code-inner js-file-line">					<span class="pl-c"><span class="pl-c">//</span> func valueInstanceOf(v ref, t ref) bool</span></td>
      </tr>
      <tr>
        <td id="L351" class="blob-num js-line-number" data-line-number="351"></td>
        <td id="LC351" class="blob-code blob-code-inner js-file-line">					<span class="pl-s"><span class="pl-pds">&quot;</span><span class="pl-en">syscall/js.valueInstanceOf</span><span class="pl-pds">&quot;</span></span><span class="pl-k">:</span> (<span class="pl-smi">sp</span>) <span class="pl-k">=&gt;</span> {</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC355" class="blob-code blob-code-inner js-file-line">					<span class="pl-s"><span class="pl-pds">&quot;</span><span class="pl-en">debug</span><span class="pl-pds">&quot;</span></span><span class="pl-k">:</span> (<span class="pl-smi">value</span>) <span class="pl-k">=&gt;</span> {</td>
      </tr>
      <tr>
        <td id="L356" class="blob-num js-line-number" data-line-number="356"></td>
        <td id="LC356" class="blob-code blob-code-inner js-file-line">						<span class="pl-en">console</span>.<span class="pl-c1">log</span>(value);</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC362" class="blob-code blob-code-inner js-file-line">		<span class="pl-k">async</span> <span class="pl-en">run</span>(<span class="pl-smi">instance</span>) {</td>
      </tr>
      <tr>
        <td id="L363" class="blob-num js-line-number" data-line-number="363"></td>
        <td id="LC363" class="blob-code blob-code-inner js-file-line">			<span class="pl-c1">this</span>.<span class="pl-smi">_inst</span> <span class="pl-k">=</span> instance;</td>
      </tr>
      <tr>
        <td id="L364" class="blob-num js-line-number" data-line-number="364"></td>
        <td id="LC364" class="blob-code blob-code-inner js-file-line">			<span class="pl-c1">this</span>.<span class="pl-smi">_values</span> <span class="pl-k">=</span> [ <span class="pl-c"><span class="pl-c">//</span> TODO: garbage collection</span></td>
      </tr>
      <tr>
        <td id="L365" class="blob-num js-line-number" data-line-number="365"></td>
        <td id="LC365" class="blob-code blob-code-inner js-file-line">				<span class="pl-c1">NaN</span>,</td>
      </tr>
      <tr>
        <td id="L366" class="blob-num js-line-number" data-line-number="366"></td>
        <td id="LC366" class="blob-code blob-code-inner js-file-line">				<span class="pl-c1">0</span>,</td>
      </tr>
      <tr>
        <td id="L367" class="blob-num js-line-number" data-line-number="367"></td>
        <td id="LC367" class="blob-code blob-code-inner js-file-line">				<span class="pl-c1">null</span>,</td>
      </tr>
      <tr>
        <td id="L368" class="blob-num js-line-number" data-line-number="368"></td>
        <td id="LC368" class="blob-code blob-code-inner js-file-line">				<span class="pl-c1">true</span>,</td>
      </tr>
      <tr>
        <td id="L369" class="blob-num js-line-number" data-line-number="369"></td>
        <td id="LC369" class="blob-code blob-code-inner js-file-line">				<span class="pl-c1">false</span>,</td>
      </tr>
      <tr>
        <td id="L370" class="blob-num js-line-number" data-line-number="370"></td>
        <td id="LC370" class="blob-code blob-code-inner js-file-line">				<span class="pl-c1">global</span>,</td>
      </tr>
      <tr>
        <td id="L371" class="blob-num js-line-number" data-line-number="371"></td>
        <td id="LC371" class="blob-code blob-code-inner js-file-line">				<span class="pl-c1">this</span>.<span class="pl-smi">_inst</span>.<span class="pl-smi">exports</span>.<span class="pl-smi">mem</span>,</td>
      </tr>
      <tr>
        <td id="L372" class="blob-num js-line-number" data-line-number="372"></td>
        <td id="LC372" class="blob-code blob-code-inner js-file-line">				<span class="pl-c1">this</span>,</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC374" class="blob-code blob-code-inner js-file-line">			<span class="pl-c1">this</span>.<span class="pl-smi">_refs</span> <span class="pl-k">=</span> <span class="pl-k">new</span> <span class="pl-en">Map</span>();</td>
      </tr>
      <tr>
        <td id="L375" class="blob-num js-line-number" data-line-number="375"></td>
        <td id="LC375" class="blob-code blob-code-inner js-file-line">			<span class="pl-c1">this</span>.<span class="pl-smi">exited</span> <span class="pl-k">=</span> <span class="pl-c1">false</span>;</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC379" class="blob-code blob-code-inner js-file-line">			<span class="pl-c"><span class="pl-c">//</span> Pass command line arguments and environment variables to WebAssembly by writing them to the linear memory.</span></td>
      </tr>
      <tr>
        <td id="L380" class="blob-num js-line-number" data-line-number="380"></td>
        <td id="LC380" class="blob-code blob-code-inner js-file-line">			<span class="pl-k">let</span> offset <span class="pl-k">=</span> <span class="pl-c1">4096</span>;</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC382" class="blob-code blob-code-inner js-file-line">			<span class="pl-k">const</span> <span class="pl-c1">strPtr</span> <span class="pl-k">=</span> (<span class="pl-smi">str</span>) <span class="pl-k">=&gt;</span> {</td>
      </tr>
      <tr>
        <td id="L383" class="blob-num js-line-number" data-line-number="383"></td>
        <td id="LC383" class="blob-code blob-code-inner js-file-line">				<span class="pl-k">let</span> ptr <span class="pl-k">=</span> offset;</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC386" class="blob-code blob-code-inner js-file-line">				<span class="pl-k">return</span> ptr;</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC389" class="blob-code blob-code-inner js-file-line">			<span class="pl-k">const</span> <span class="pl-c1">argc</span> <span class="pl-k">=</span> <span class="pl-c1">this</span>.<span class="pl-smi">argv</span>.<span class="pl-c1">length</span>;</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC391" class="blob-code blob-code-inner js-file-line">			<span class="pl-k">const</span> <span class="pl-c1">argvPtrs</span> <span class="pl-k">=</span> [];</td>
      </tr>
      <tr>
        <td id="L392" class="blob-num js-line-number" data-line-number="392"></td>
        <td id="LC392" class="blob-code blob-code-inner js-file-line">			<span class="pl-c1">this</span>.<span class="pl-smi">argv</span>.<span class="pl-c1">forEach</span>((<span class="pl-smi">arg</span>) <span class="pl-k">=&gt;</span> {</td>
      </tr>
      <tr>
        <td id="L393" class="blob-num js-line-number" data-line-number="393"></td>
        <td id="LC393" class="blob-code blob-code-inner js-file-line">				<span class="pl-smi">argvPtrs</span>.<span class="pl-c1">push</span>(<span class="pl-en">strPtr</span>(arg));</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC396" class="blob-code blob-code-inner js-file-line">			<span class="pl-k">const</span> <span class="pl-c1">keys</span> <span class="pl-k">=</span> <span class="pl-c1">Object</span>.<span class="pl-c1">keys</span>(<span class="pl-c1">this</span>.<span class="pl-smi">env</span>).<span class="pl-c1">sort</span>();</td>
      </tr>
      <tr>
        <td id="L397" class="blob-num js-line-number" data-line-number="397"></td>
        <td id="LC397" class="blob-code blob-code-inner js-file-line">			<span class="pl-smi">argvPtrs</span>.<span class="pl-c1">push</span>(<span class="pl-smi">keys</span>.<span class="pl-c1">length</span>);</td>
      </tr>
      <tr>
        <td id="L398" class="blob-num js-line-number" data-line-number="398"></td>
        <td id="LC398" class="blob-code blob-code-inner js-file-line">			<span class="pl-smi">keys</span>.<span class="pl-c1">forEach</span>((<span class="pl-smi">key</span>) <span class="pl-k">=&gt;</span> {</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC402" class="blob-code blob-code-inner js-file-line">			<span class="pl-k">const</span> <span class="pl-c1">argv</span> <span class="pl-k">=</span> offset;</td>
      </tr>
      <tr>
        <td id="L403" class="blob-num js-line-number" data-line-number="403"></td>
        <td id="LC403" class="blob-code blob-code-inner js-file-line">			<span class="pl-smi">argvPtrs</span>.<span class="pl-c1">forEach</span>((<span class="pl-smi">ptr</span>) <span class="pl-k">=&gt;</span> {</td>
      </tr>
      <tr>
        <td id="L404" class="blob-num js-line-number" data-line-number="404"></td>
        <td id="LC404" class="blob-code blob-code-inner js-file-line">				<span class="pl-smi">mem</span>.<span class="pl-en">setUint32</span>(offset, ptr, <span class="pl-c1">true</span>);</td>
      </tr>
      <tr>
        <td id="L405" class="blob-num js-line-number" data-line-number="405"></td>
        <td id="LC405" class="blob-code blob-code-inner js-file-line">				<span class="pl-smi">mem</span>.<span class="pl-en">setUint32</span>(offset <span class="pl-k">+</span> <span class="pl-c1">4</span>, <span class="pl-c1">0</span>, <span class="pl-c1">true</span>);</td>
      </tr>
      <tr>
        <td id="L406" class="blob-num js-line-number" data-line-number="406"></td>
        <td id="LC406" class="blob-code blob-code-inner js-file-line">				offset <span class="pl-k">+=</span> <span class="pl-c1">8</span>;</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC409" class="blob-code blob-code-inner js-file-line">			<span class="pl-c1">this</span>.<span class="pl-smi">_inst</span>.<span class="pl-smi">exports</span>.<span class="pl-en">run</span>(argc, argv);</td>
      </tr>
      <tr>
        <td id="L410" class="blob-num js-line-number" data-line-number="410"></td>
        <td id="LC410" class="blob-code blob-code-inner js-file-line">			<span class="pl-k">if</span> (<span class="pl-c1">this</span>.<span class="pl-smi">exited</span>) {</td>
      </tr>
      <tr>
        <td id="L411" class="blob-num js-line-number" data-line-number="411"></td>
        <td id="LC411" class="blob-code blob-code-inner js-file-line">				<span class="pl-c1">this</span>.<span class="pl-en">_resolveExitPromise</span>();</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC413" class="blob-code blob-code-inner js-file-line">			<span class="pl-k">await</span> <span class="pl-c1">this</span>.<span class="pl-smi">_exitPromise</span>;</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC416" class="blob-code blob-code-inner js-file-line">		<span class="pl-en">_resume</span>() {</td>
      </tr>
      <tr>
        <td id="L417" class="blob-num js-line-number" data-line-number="417"></td>
        <td id="LC417" class="blob-code blob-code-inner js-file-line">			<span class="pl-k">if</span> (<span class="pl-c1">this</span>.<span class="pl-smi">exited</span>) {</td>
      </tr>
      <tr>
        <td id="L418" class="blob-num js-line-number" data-line-number="418"></td>
        <td id="LC418" class="blob-code blob-code-inner js-file-line">				<span class="pl-k">throw</span> <span class="pl-k">new</span> <span class="pl-en">Error</span>(<span class="pl-s"><span class="pl-pds">&quot;</span>bad callback: Go program has already exited<span class="pl-pds">&quot;</span></span>);</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC420" class="blob-code blob-code-inner js-file-line">			<span class="pl-c1">this</span>.<span class="pl-smi">_inst</span>.<span class="pl-smi">exports</span>.<span class="pl-en">resume</span>();</td>
      </tr>
      <tr>
        <td id="L421" class="blob-num js-line-number" data-line-number="421"></td>
        <td id="LC421" class="blob-code blob-code-inner js-file-line">			<span class="pl-k">if</span> (<span class="pl-c1">this</span>.<span class="pl-smi">exited</span>) {</td>
      </tr>
      <tr>
        <td id="L422" class="blob-num js-line-number" data-line-number="422"></td>
        <td id="LC422" class="blob-code blob-code-inner js-file-line">				<span class="pl-c1">this</span>.<span class="pl-en">_resolveExitPromise</span>();</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC426" class="blob-code blob-code-inner js-file-line">		<span class="pl-en">_makeCallbackHelper</span>(<span class="pl-smi">id</span>) {</td>
      </tr>
      <tr>
        <td id="L427" class="blob-num js-line-number" data-line-number="427"></td>
        <td id="LC427" class="blob-code blob-code-inner js-file-line">			<span class="pl-k">const</span> <span class="pl-c1">go</span> <span class="pl-k">=</span> <span class="pl-c1">this</span>;</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC429" class="blob-code blob-code-inner js-file-line">				<span class="pl-k">const</span> <span class="pl-c1">cb</span> <span class="pl-k">=</span> { id<span class="pl-k">:</span> id, this<span class="pl-k">:</span> <span class="pl-c1">this</span>, args<span class="pl-k">:</span> <span class="pl-c1">arguments</span> };</td>
      </tr>
      <tr>
        <td id="L430" class="blob-num js-line-number" data-line-number="430"></td>
        <td id="LC430" class="blob-code blob-code-inner js-file-line">				<span class="pl-smi">go</span>.<span class="pl-smi">_pendingCallback</span> <span class="pl-k">=</span> cb;</td>
      </tr>
      <tr>
        <td id="L431" class="blob-num js-line-number" data-line-number="431"></td>
        <td id="LC431" class="blob-code blob-code-inner js-file-line">				<span class="pl-smi">go</span>.<span class="pl-en">_resume</span>();</td>
      </tr>
      <tr>
        <td id="L432" class="blob-num js-line-number" data-line-number="432"></td>
        <td id="LC432" class="blob-code blob-code-inner js-file-line">				<span class="pl-k">return</span> <span class="pl-smi">cb</span>.<span class="pl-smi">result</span>;</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC437" class="blob-code blob-code-inner js-file-line">	<span class="pl-k">if</span> (isNodeJS) {</td>
      </tr>
      <tr>
        <td id="L438" class="blob-num js-line-number" data-line-number="438"></td>
        <td id="LC438" class="blob-code blob-code-inner js-file-line">		<span class="pl-k">if</span> (<span class="pl-c1">process</span>.<span class="pl-smi">argv</span>.<span class="pl-c1">length</span> <span class="pl-k">&lt;</span> <span class="pl-c1">3</span>) {</td>
      </tr>
      <tr>
        <td id="L439" class="blob-num js-line-number" data-line-number="439"></td>
        <td id="LC439" class="blob-code blob-code-inner js-file-line">			<span class="pl-c1">process</span>.<span class="pl-smi">stderr</span>.<span class="pl-c1">write</span>(<span class="pl-s"><span class="pl-pds">&quot;</span>usage: go_js_wasm_exec [wasm binary] [arguments]<span class="pl-cce">\n</span><span class="pl-pds">&quot;</span></span>);</td>
      </tr>
      <tr>
        <td id="L440" class="blob-num js-line-number" data-line-number="440"></td>
        <td id="LC440" class="blob-code blob-code-inner js-file-line">			<span class="pl-c1">process</span>.<span class="pl-en">exit</span>(<span class="pl-c1">1</span>);</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC443" class="blob-code blob-code-inner js-file-line">		<span class="pl-k">const</span> <span class="pl-c1">go</span> <span class="pl-k">=</span> <span class="pl-k">new</span> <span class="pl-en">Go</span>();</td>
      </tr>
      <tr>
        <td id="L444" class="blob-num js-line-number" data-line-number="444"></td>
        <td id="LC444" class="blob-code blob-code-inner js-file-line">		<span class="pl-smi">go</span>.<span class="pl-smi">argv</span> <span class="pl-k">=</span> <span class="pl-c1">process</span>.<span class="pl-smi">argv</span>.<span class="pl-c1">slice</span>(<span class="pl-c1">2</span>);</td>
      </tr>
      <tr>
        <td id="L445" class="blob-num js-line-number" data-line-number="445"></td>
        <td id="LC445" class="blob-code blob-code-inner js-file-line">		<span class="pl-smi">go</span>.<span class="pl-smi">env</span> <span class="pl-k">=</span> <span class="pl-c1">process</span>.<span class="pl-smi">env</span>;</td>
      </tr>
      <tr>
        <td id="L446" class="blob-num js-line-number" data-line-number="446"></td>
        <td id="LC446" class="blob-code blob-code-inner js-file-line">		<span class="pl-smi">go</span>.<span class="pl-smi">exit</span> <span class="pl-k">=</span> <span class="pl-c1">process</span>.<span class="pl-smi">exit</span>;</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC449" class="blob-code blob-code-inner js-file-line">				<span class="pl-k">if</span> (code <span class="pl-k">===</span> <span class="pl-c1">0</span> <span class="pl-k">&amp;&amp;</span> <span class="pl-k">!</span><span class="pl-smi">go</span>.<span class="pl-smi">exited</span>) {</td>
      </tr>
      <tr>
        <td id="L450" class="blob-num js-line-number" data-line-number="450"></td>
        <td id="LC450" class="blob-code blob-code-inner js-file-line">					<span class="pl-c"><span class="pl-c">//</span> deadlock, make Go print error and stack traces</span></td>
      </tr>
      <tr>
        <td id="L451" class="blob-num js-line-number" data-line-number="451"></td>
        <td id="LC451" class="blob-code blob-code-inner js-file-line">					<span class="pl-smi">go</span>.<span class="pl-smi">_pendingCallback</span> <span class="pl-k">=</span> { id<span class="pl-k">:</span> <span class="pl-c1">0</span> };</td>
      </tr>
      <tr>
        <td id="L452" class="blob-num js-line-number" data-line-number="452"></td>
        <td id="LC452" class="blob-code blob-code-inner js-file-line">					<span class="pl-smi">go</span>.<span class="pl-en">_resume</span>();</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC455" class="blob-code blob-code-inner js-file-line">			<span class="pl-k">return</span> <span class="pl-smi">go</span>.<span class="pl-en">run</span>(<span class="pl-smi">result</span>.<span class="pl-smi">instance</span>);</td>
      </tr>
      <tr>
        <td id="L456" class="blob-num js-line-number" data-line-number="456"></td>
        <td id="LC456" class="blob-code blob-code-inner js-file-line">		}).<span class="pl-c1">catch</span>((<span class="pl-smi">err</span>) <span class="pl-k">=&gt;</span> {</td>
      </tr>
      <tr>
        <td id="L457" class="blob-num js-line-number" data-line-number="457"></td>
        <td id="LC457" class="blob-code blob-code-inner js-file-line">			<span class="pl-k">throw</span> err;</td>
      </tr>
      <tr>
  ...
  <details class="details-reset details-overlay BlobToolbar position-absolute js-file-line-actions dropdown d-none" aria-hidden="true">
    ...
    <details-menu>
      <ul class="BlobToolbar-dropdown dropdown-menu dropdown-menu-se mt-2">
        ...
        <li><a class="dropdown-item js-update-url-with-hash" id="js-view-git-blame" role="menuitem" href="/golang/go/blame/14608976dbaff72b7ff6b41b66623c959eaded28/misc/wasm/wasm_exec.js">View git blame</a></li>
...
<div class="footer container-lg px-3" role="contentinfo">
  <div class="position-relative d-flex flex-justify-between pt-6 pb-2 mt-6 f6 text-gray border-top border-gray-light ">
    <ul class="list-style-none d-flex flex-wrap ">
      <li class="mr-3">&copy; 2018 <span title="0.21985s from unicorn-774897c55d-tngkd">GitHub</span>, Inc.</li>
